...
imageFacesPath = "C:/Users/User/Desktop/Face_Recognition2/images/faces"
...
while True:
     ...
     for (x, y, w, h) in faces:
          ...
          if True in result:
               ...
               # Aquí agregamos las líneas para que hable el nombre
               # Decir el nombre de la persona identificada
               engine.say(f" {name}")
               engine.runAndWait()
          else:
               name = "Desconocido"
